...
class ConfigData:
    def __init__(self, data_dir: str = "./data", split_type: str = "train"):
        ...
        if split_type == "train":
            ...
            self.input_ary_path = f"{data_dir}/BTC_1sec_input_train_70.npy"
            self.label_ary_path = f"{data_dir}/BTC_1sec_label_train_70.npy"
            self.predict_ary_path = f"{data_dir}/BTC_1sec_predict_train_70.npy"
        elif split_type == "test":
            # Use the 15% test split file
            self.csv_path = f"{data_dir}/BTC_1sec_with_sentiment_risk_test_15.csv"
            self.input_ary_path = f"{data_dir}/BTC_1sec_input_test_15.npy"
            self.label_ary_path = f"{data_dir}/BTC_1sec_label_test_15.npy"
            ...
            self.input_ary_path = f"{data_dir}/BTC_1sec_input_val.npy"
            self.label_ary_path = f"{data_dir}/BTC_1sec_label_val.npy"
